...
- มีความซับซ้อนในการบิหารจัดการ VM หลายเครื่อง เช่น อัพเดท OS, patch ความปลอดภัย, backup
- มีค่าใช้จ่ายสูง เนื่องจากต้องใช้เครื่องที่แรกมากพอจึงจะรองรับการทำงานได้หลาย VM และต้องคำนึงถึง license ต่าง ๆ ของแต่ละ os ที่่จะทำมาใช้งานใน vm แต่ละเครื่อง